    ...
    <div className="screen" style={{ gap: 0, paddingTop: 0 }}>
      ...
      <div style={{
        ...
        <div style={{ flex: 1 }}>
          ...
          <div style={{ fontSize: 20, fontWeight: 800, color: "var(--text)" }}>WortWelle</div>
        </div>
        <button onClick={() => setShowStats(true)} style={{ ...iconBtnStyle, color: ACCENT, borderColor: ACCENT + "44" }} title="Statistiken">📊</button>
        <button onClick={() => setShowRules(true)} style={{ ...iconBtnStyle, color: ACCENT, borderColor: ACCENT + "44" }} title="Regeln">?</button>
      </div>
